...
public class UserAuthenticator {
    ...
    private static String readPasswordSecurely() {
        // In a real application, you would implement secure password input.
        // For simplicity, we will use plain text here.
        Scanner scanner = new Scanner(System.in);
        return scanner.nextLine();
    }
    private static boolean authenticateUser(String username, String password) throws
